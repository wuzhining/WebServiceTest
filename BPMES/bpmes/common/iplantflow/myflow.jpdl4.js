...
$.extend(true,myflow.config.tools.states,{
			start : {
				...
				name : {text:'<<start>>'},
				text : {text:'开始'},
				img : {src : '../../common/iplantflow/img/48/start_event_empty.png',width : 48, height:48},
				...
				name : {text:'<<end>>'},
				text : {text:'结束'},
				img : {src : '../../common/iplantflow/img/48/end_event_terminate.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-cancel' : {
				...
				text : {text:'取消'},
				img : {src : '../../common/iplantflow/img/48/end_event_cancel.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-error' : {
				...
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src : '../../common/iplantflow/img/48/end_event_error.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			state : {
				...
				name : {text:'<<state>>'},
				text : {text:'状态'},
				img : {src : '../../common/iplantflow/img/48/task_empty.png',width : 48, height:48},
				props : {
			...
			decision : {
				...
				name : {text:'<<decision>>'},
				text : {text:'判断'},
				img : {src : '../../common/iplantflow/img/48/gateway_exclusive.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			fork : {
				...
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : '../../common/iplantflow/img/48/gateway_parallel.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
