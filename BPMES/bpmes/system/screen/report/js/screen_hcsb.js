	           ...
	           successCallBack: function (data) {
	        	   ...
	        	   if(data.RESPONSE[0].length != 0){
	        		   ...
	        		   if(rowCollection.length>0){
	        			   for(var i=0; i<rowCollection.length; i++){
	        				   if(i<20){
	        					   tm.push(rowCollection[i].BAR_CODE);
	        					   arr.push(parseInt(rowCollection[i].DEF_A));
	        				   }
	        			   }
	        		   }
	        	   }
			       ...
			       Highcharts.chart('container1', {
					    ...
					    title: {
					        text: '<span style="color:#1771B3;font-size:14px;">缓存明细</span>'
					    },
//					    subtitle: {
...
//					    },
					    ...
					    series: [{
					        name: '<span style="color:#1771B3">PCB</span>',
					        data: arr
					    }],
					    credits: {
					          enabled:false
