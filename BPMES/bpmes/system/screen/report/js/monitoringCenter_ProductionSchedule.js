	...
	function myFunc(){
		...
		Highcharts.chart('container3', {
	        ...
	        series: [{
	            ...
	            name: '原因占比',
	            data: [
	                ['<span style="color:#19a0f5;font-size: 12px">机器坏 ,41.0%</span>',   41.0],						                
	                {
	                    name: '<span style="color:#19a0f5;font-size: 12px">换线,31.0%</span>',
	                    y: 31.0,
	                    sliced: true,
	                    selected: true
	                },
	                ['<span style="color:#19a0f5;font-size: 12px">来料异常,10.0%</span>',    10.0],
	                ['<span style="color:#19a0f5;font-size: 12px">软件问题,8.0%</span>',     8.0],
	                ['<span style="color:#19a0f5;font-size: 12px">视觉不良,10.0%</span>',   10.0]
	            ]
	        }],
	        credits: {
		          enabled:false
