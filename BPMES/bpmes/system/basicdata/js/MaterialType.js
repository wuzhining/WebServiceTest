(function() {
	function dictItem() {
		pageConfig = {
			dictCD : windowPageConfig.dictCode || 'CPT01',
			gridName : windowPageConfig.gridName || 'materialType_tab',
			txtDictCode : windowPageConfig.txtDictCode || 'txtMaterialCode',
			txtDictName : windowPageConfig.txtDictName || 'txtMaterialName',
			cbUsed : windowPageConfig.windowPageConfig || 'cbUsedFlag',
			dictRemark : windowPageConfig.dictRemark || 'txtDictRemrk',
			title : windowPageConfig.title || '物料类别',	
			gcDictCD : windowPageConfig.gcDictCD || '物料类别编号',
			gcDictName : windowPageConfig.gcDictName || '物料类别名称'
		}
