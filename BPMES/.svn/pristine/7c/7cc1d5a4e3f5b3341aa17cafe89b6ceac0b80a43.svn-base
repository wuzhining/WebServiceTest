(function(b) {
    ...
    a.rect = function(p, m) {
        ...
        this.toJson = function(id) {
            var r = "{\"id\":\""+id+"\",\"type\":\"" + E.type + "\",\"text\":{\"text\":\"" + f.attr("text") + "\"}, \"attr\":{ \"x\":" + Math.round(t.attr("x")) + ", \"y\":" + Math.round(t.attr("y")) + ", \"width\":" + Math.round(t.attr("width")) + ", \"height\":" + Math.round(t.attr("height")) + "}, \"props\":{";
       ...
       b(document).keydown(function (i,byButton) {
        ...
        if (a.config.editable) {
            ...
            b("#myflow_save").click(function() {
                ...
                for (var c in q) {
                    if (q[c]) {
                        i += "\""+q[c].getId() + "\":" + q[c].toJson(q[c].getId()) + ","
                    }
                }
