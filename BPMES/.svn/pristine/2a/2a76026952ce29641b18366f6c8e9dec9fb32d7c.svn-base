		           ...
		           successCallBack: function (data) {
		        	   if(data.RESPONSE[0].length != 0){
		        		   ...
		        		   if(rowCollection.length>0){
			        		   ...
			        		   cj_num = parseFloat(rowCollection[0].PROD_QTY) * 12; 				/*插件数量*/
		       ...
		       iplantAjaxRequest({
		           ...
		           successCallBack: function (data) {
		        	   ...
		        	   if(data.RESPONSE[0].RESPONSE_DATA.length>0){
		        		   ...
		        		   for(var i=0; i<rowCollection.length; i++){
		        			   /*原版*/
		        			   Aarr.push(parseFloat(rowCollection[i].PLUD_NUM));
		        			   Aarr.push(parseFloat(rowCollection[i].FM_NUM));
		        			   Aarr.push(parseFloat(rowCollection[i].EP_NUM));
		        			   Aarr.push(parseFloat(rowCollection[i].FM_OE));
		        			   Aarr.push(parseFloat(rowCollection[i].SUCK_OE));
		        			   /*东莞展会更新*/
		        			   /*Aarr.push(cj_num);
		        			   Aarr.push(parseInt(cj_num * 0.003));							抛料数
		        			   Aarr.push(parseFloat(rowCollection[i].EP_NUM));		空抛数
		        			   Aarr.push(3);										抛料率
		        			   Aarr.push(parseFloat(rowCollection[i].SUCK_OE));*/
		        		   };
		        		   barCode = rowCollection[0].BAR_CODE;
		        	   }else{
		        		   Aarr = [0,0,0,0,0];
		        		   barCode = '';
		        	   };
		        	   Highcharts.chart('container1', {
		       			 ...
		       			 plotOptions: {
		       			    ...
		       			    series: [{
		       			        name: '<span style="color:#1771B3">'+barCode+'</span>',
		       			        data: Aarr
		       			        }],
		       			    credits: {
		       			          enabled:false
