                    ...
                    successCallBack:function(data){
                    	...
                    	if(rowCollection.length>0){
                    		...
                    		for(var i=0; i<rowCollection.length; i++){
                    			...
                    			//停机
                    			else if(rowCollection[i].DICT_IT=="RDI01.04" || rowCollection[i].DICT_IT=="RDI01.09" || rowCollection[i].DICT_IT=="RDI01.10"){
                    				stopCnt+=parseInt(rowCollection[i].TOT);
                    			}
                    			//计划停机
            				...
            				//停机
            				$("#tjts").text(stopCnt); 
            				$("#tjbl").text(((stopCnt/counts)*100).toFixed(2)+"%");
                    	}
                    }
    		};
