	...
	function csbkbInfo(){
		ccfunc = function (){
		       ...
		       iplantAjaxRequest({
		           ...
		           data: {
		               IFS: 'MES_R0024',
		               TEST_EQ_ONE:'ZZD111111111111111111111112',
		               TEST_EQ_TWO:'ZZD11111111111111111111113',
		               REQ_TIME:dtime,
		               LINE_CD:lx,
		               ET_CD:sbbm
		           },
		           successCallBack: function (data) {
		        	   ...
		        	   if(data.RESPONSE[0].RESPONSE_DATA.length>0){
		        		   ...
		        		   tm = ['SWITCH TO SECHA','RESEC CHE HIPORT TEST','SWITCH TO AV','SECHA TEST','AV TEST','HIPORT TEST','HOMI TEST'];
			        	   Aarr = [0,0,0,0,0,0,0];
		        	   };
		        	   Highcharts.chart('container1', {
		       			    ...
		       			    title: {
		       			        text: '<span style="color:#1771B3;font-size:14px;">次品示意图</span>'
		       			    },
			       			 plotOptions: {
			       			        column: {
			       			            depth: 25,
