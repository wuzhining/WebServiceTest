...
(function() {
	function tasklogic() {
		...
		initGridData = function() {
			...
			reqGridData('/iPlant_ajax', 'tasklogic_tab', reqData);
		},
		bindGridData = function(reqData, jsonData) {
			var gridList = {
				...
				columns: [[
					...
					{field: 'LG_FT_CD',title: '逻辑作业代码',width: 100,align: 'center',formatter: function (value) {if(checkNotEmpty(value)) return "<span title='" + value + "'>" + value + "</span>";},editor:{type:'validatebox',
...
//			                        	dataGrid.datagrid('deleteRow', indexs[j]);
	...
	tasklogic.prototype = {
		init: function() {
			$(function() {
				//初始化全局变量对象
				dataGrid = $('#tasklogic_tab'),dataCompany=[],dataFactory=[],showmessage=$('#showMessageInfo'),editIndex = undefined,oldRow=undefined, reg=new RegExp("null","g");
				initGridData();
				//获取工厂类别下拉
				$('.add').click(function() {					
					insertDataGrid();
