	       ...
	       iplantAjaxRequest({
	           ...
	           successCallBack: function (data) {
	        	   if(data.RESPONSE[0].RESPONSE_DATA.length != 0){
	        		   var rowCollection = createSourceObj(data);
	        		   if(rowCollection.length>0){
	        			   for(var numerical in rowCollection[0]){
	        				   $('#'+numerical).html(rowCollection[0][numerical]);
	        			   }
	        		   }else{
	        			   $('#EquipmentStateTB tr td[id]').html('');
	        		   }
	        	   }
	           }
	       });
	           ...
	           successCallBack: function (data) {
	        	   ...
	        	   if(data.RESPONSE[0].length != 0){
	        		   ...
	        		   Highcharts.chart('container3', {
	       			    ...
	       			    title: {
	       			        text: '<span style="color:#1771B3;font-size:14px;">设备状态示意图（'+'白班'+'）</span>'
	       			    },
	        	   ...
	        	   if(data.RESPONSE[0].length != 0){
	       			...
	       			Highcharts.chart('container2', {
	       			 ...
	       			 plotOptions: {
	       			    ...
	       			    series: [{
	       			        name: '<span style="color:#1771B3;font-size:8px;">运动稼动率</span>',
	       			        data: Aarr

	       			    }, {
	       			        name: '<span style="color:#1771B3;font-size:8px;">性能稼动率</span>',
	       			        data:Barr

	       			    }, {
	       			        name: '<span style="color:#1771B3;font-size:8px;">直通率</span>',
	       			        data: Carr

	       			    }, {
	       			        name: '<span style="color:#1771B3;font-size:8px;">OEE</span>',
	       			        data:Darr
