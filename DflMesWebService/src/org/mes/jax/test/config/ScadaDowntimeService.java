 ...
 * 
 */
@WebService(name = "ScadaDowntimeService", targetNamespace = "http://service.jax.mes.org/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ScadaDowntimeService {
    ...
    @Action(input = "http://service.jax.mes.org/ScadaDowntimeService/doServiceRequest", output = "http://service.jax.mes.org/ScadaDowntimeService/doServiceResponse")
