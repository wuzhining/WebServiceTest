...
import org.mes.jax.utils.CoreFrameworkConstants;
...
public class LogUtil
{
	...
	private static Log getParentLog()
	{
		...
		catch (Exception e)
		{
			...
			for (int i = 0; i < sts.length; i++)
			{
				try
				{
					...
					{
						return LogFactory.getLog(Class.forName(sts[i]
								.getClassName()));
					}
				}
		...
		return frameLog;// 找不到的就使用当前类
	}

	protected static String getLogText(Object o)
	{
	    String requestId = CoreFrameworkConstants.SYSTEM_REQUEST_ID;
	    try {
